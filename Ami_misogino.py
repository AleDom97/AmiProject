...
# Example data
y_pos = np.arange(len(df_parole['Parole']))

ax.barh(y_pos, df_parole['N° parole'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df_parole['Parole'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° parole')
ax.set_title('Parole più usate nel dataset generale')
...
# Example data
y_pos = np.arange(len(df0_parole['Parole']))

ax.barh(y_pos, df0_parole['N° parole'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df0_parole['Parole'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° parole')
ax.set_title('Parole più usate nel dataset non misogino')
...
# Example data
y_pos = np.arange(len(df1_parole['Parole']))

ax.barh(y_pos, df1_parole['N° parole'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df1_parole['Parole'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° parole')
ax.set_title('Parole più usate nel dataset misogino')
...
# Example data
y_pos = np.arange(len(df_emoji['Emoji']))

ax.barh(y_pos, df_emoji['N° emoji'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df_emoji['Emoji'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° emoji')
ax.set_title('Emoji più usate nel dataset generale')
...
# Example data
y_pos = np.arange(len(df0_emoji['Emoji']))

ax.barh(y_pos, df0_emoji['N° emoji'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df0_emoji['Emoji'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° emoji')
ax.set_title('Emoji più usate nel dataset non misogino')
...
# Example data
y_pos = np.arange(len(df1_emoji['Emoji']))

ax.barh(y_pos, df1_emoji['N° emoji'], align='center',color=['Maroon', 'Brown', 'Olive', 'Teal', 'Navy','Red','Orange','Yellow','lime','green','cyan','blue','purple','Magenta','pink','Aquamarine','Beige','Coral','Lavender','Grey'])
ax.set_yticks(y_pos)
ax.set_yticklabels(df1_emoji['Emoji'])
ax.invert_yaxis()  # labels read top-to-bottom
ax.set_xlabel('N° emoji')
ax.set_title('Emoji più usate nel dataset misogino')
...
df_ami.to_csv('df_ami.csv', encoding='utf-8')
...
'''
predizione_m = model_final.predict([X_test_embedding,X_test_features])
predizione_final2 = np.argmax(predizione_m, axis=1)
